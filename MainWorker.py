...
input1 = int(input())
print("")
print("Tip: de-GE is the default language")
print("Language:")
Language1 = input()
print("Tip: the default speed is 178")
print("Speed:")
speed = int(input())
print("Tip: the default volume is 1")
print("Speed:")
volume = int(input())

friday.setProperty('voice', voices[input1].id)
friday.setProperty("rate", speed)
friday.setProperty("volume", volume)


def speak(audio):
    print('VTuber TTS: ' + audio)
    friday.say(audio)
    friday.runAndWait()
